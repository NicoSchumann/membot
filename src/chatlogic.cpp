                ...
                if (idToken != tokens.end())
                {
                    ...
                    if (type->second == "NODE")
                    {
                        ...
                        if (it == _nodes.end())
                        {
                            ...
                            it = _nodes.end() - 1; // get iterator to last element

                            // add all answers to current node
                            AddAllTokensToElement("ANSWER", tokens, *(it->get()) );
                        }
                    ...
                    if (type->second == "EDGE")
                    {
                        ...
                        {
                            //auto parentNode = std::find_if(_nodes.begin(), _nodes.end(), [&parentToken](std::unique<GraphNode> node) { return node->GetID() == std::stoi(parentToken->second); });
